          ...
          {query.length === 0 && (
            <div className="p-3 sm:p-4 bg-gray-50 border-t safe-area-bottom">
              <div className="flex flex-wrap gap-2">
                ...
                <Link
                  href={{ pathname: '/products', query: { collection_id: 'pcol_01K6582SDF4VDSDDCRB3J3WNVM', page: 1 } }}
                  onClick={onClose}
                ...
                <Link
                  href={{ pathname: '/products', query: { collection_id: 'pcol_01K65824AQ7PKJV8ZAM9E5RB71', page: 1 } }}
                  onClick={onClose}
                  className="px-4 py-3 bg-white border rounded-lg text-sm text-gray-700 hover:bg-gray-50 transition-colors touch-manipulation min-h-[44px] flex items-center"
                >
                  Best Seller
                ...
                <Link
                  href={{ pathname: '/products', query: { collection_id: 'pcol_01K6583CAWE3N7JPS55M881G0B', page: 1 } }}
                  onClick={onClose}
                  className="px-4 py-3 bg-white border rounded-lg text-sm text-gray-700 hover:bg-gray-50 transition-colors touch-manipulation min-h-[44px] flex items-center"
                >
                  Sale
